  ...
  <div class="container mx-auto">
    ...
    <form action="/penjual/tambah-produk" class="flex flex-col w-[40rem] mx-auto" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-4">
        ...
        <input value="{{ $produk->nama }}" type="text" id="nama" name="nama" class="w-full px-4 py-2 border border-gray-300 rounded"
          required>
      </div>

      <div class="mb-4">
        <label for="deskripsi" class="block text-gray-700 font-bold mb-2">Deskripsi:</label>
        <textarea id="deskripsi" name="deskripsi" class="w-full px-4 py-2 border border-gray-300 rounded" required>
          {{ $produk->deskripsi }}
        </textarea>
      </div>
      ...
      <div class="mb-4">
        ...
        <input value="{{ $produk->harga }}" type="number" id="harga" name="harga" class="w-full px-4 py-2 border border-gray-300 rounded"
          required>
      </div>

      <div class="mb-4">
        <label for="satuan" class="block text-gray-700 font-bold mb-2">Satuan:</label>
        <input value="{{ $produk->deskripsi }}" type="text" id="satuan" name="satuan" class="w-full px-4 py-2 border border-gray-300 rounded"
          required>
      </div>

      <div class="mb-4">
        <label for="foto_produk" class="block text-gray-700 font-bold mb-2">Foto Produk:</label>
        <input value="{{ $produk->foto_produk }}" type="file" id="foto_produk" name="foto_produk"
      ...
      <div class="self-center mb-4">
        <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded ">Edit Produk</button>
      </div>
    </form>
  </div>
  <x-footer />
